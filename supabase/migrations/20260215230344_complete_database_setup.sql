/*
  ...
  1. **members** - Üye bilgileri (TC, adres, cinsiyet, meslek, eğitim vb.)
  2. **announcements** - Duyurular (başlık, içerik, son kullanma tarihi)
  3. **events** - Etkinlikler (başlık, tarih, konum)
  4. **admin_settings** - Yönetim ayarları
  5. **dues** - Aidat tanımları (tutar, dönem, son ödeme tarihi)
  6. **member_dues** - Üye aidat kayıtları (ödeme durumu, tutar, yöntem)
  7. **galleries** - Galeri kategorileri
  8. **gallery_images** - Galeri fotoğrafları
  9. **event_participants** - Etkinlik katılımcıları
  10. **notifications** - Bildirimler (email/sms)
  11. **notification_recipients** - Bildirim alıcıları
  12. **donations** - Bağışlar
  13. **audit_logs** - Denetim kayıtları
  14. **contact_info** - İletişim bilgileri
  15. **management_info** - Yönetim kurulu bilgileri
  16. **page_settings** - Sayfa görünürlük ayarları

  ## Otomatik Özellikler:
  - İlk kaydolan üye otomatik admin olur
  - Yeni aidat tanımlandığında tüm aktif üyelere otomatik atanır
  ...
  ## Güvenlik:
  - Admin: Tüm işlemler
  - Üyeler: Sadece kendi bilgilerini görüntüleme/güncelleme
  - Genel: Duyurular, etkinlikler görüntüleme
*/
