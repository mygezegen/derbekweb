          ...
          <div className="bg-red-50 border-l-4 border-red-500 p-4 mb-6 rounded flex items-start gap-3">
            ...
            <div>
              ...
              <button
                ...
                className="text-red-600 underline text-sm mt-2 font-medium"
              >
                Giriş sayfasına dön ve tekrar deneyin
              </button>
            </div>
          </div>
        )}
        ...
        {sessionReady && (
          <form onSubmit={handleResetPassword} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-red-600 to-red-700 text-white py-3 rounded-lg hover:from-red-700 hover:to-red-800 disabled:bg-gray-400 transition-all font-medium shadow-md flex items-center justify-center gap-2"
            >
